// ─── FILE: src/mmio.rs  (replace entire file) ────────────────────────────

#![allow(clippy::missing_safety_doc)] // keep clippy clean for the module-level note
...
//! behaviour* on ARM.
//
//  NOTE: The `# Safety` paragraphs below satisfy Clippy’s
//  `missing_safety_doc` lint.
